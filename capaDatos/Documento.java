...
int montoPen_docu;
int abonos_docu;
Date fechUltimo_docu;
int docu_docu;
int cuota_docu;
int cuotaActual_docu;

    public Documento() {
    }

    public Documento(String rut_docu, String digito_docu, String nomCli_docu, String tipoDoc_docu, int numDoc_docu, int montoPen_docu, int abonos_docu, Date fechUltimo_docu, int docu_docu, int cuota_docu, int cuotaActual_docu) {
